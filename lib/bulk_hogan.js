...
void function () {
  var assert, async, contents, dir, fs, fse, glob, hogan, modulePrefixedBasenameWithoutExtension, name, noErr, path, readAndCompileTemplates, resultEquals, setup, sources;
  fs = require('fs');
  hogan = require('hogan.js');
  async = require('async');
  glob = require('glob');
  module.exports = setup = function (param$) {
    var baseDirectory, cache$, compiledCache, load, modulesDirectory, reload, render, renderSync, source, sourceCache;
    {
      cache$ = param$;
    ...
    renderSync = function (name, view) {
      ...
      return compiledTemplate.render(view, compiledCache);
    };
    load = function (cb) {
      if (null != compiledCache)
